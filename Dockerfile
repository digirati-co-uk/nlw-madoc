...
ADD --chown=www-data:www-data ./translations/madoc/cy.mo /srv/omeka/application/madoc/cy.mo
ADD --chown=www-data:www-data ./translations/s/war-navigation-cy.mo /srv/omeka/s/war-tribunal-records/navigation/cy.mo
